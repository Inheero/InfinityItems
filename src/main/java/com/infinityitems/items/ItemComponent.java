...
public class ItemComponent extends Item {
    ...
    public static final String[] ITEMS = new String[] {
            "capacitor1lvl", "capacitor2lvl", "capacitor3lvl", "capacitor4lvl",
            "gpu1lvl", "gpu2lvl", "gpu3lvl", "gpu4lvl",
            "chip8Bit", "chip16Bit", "chip32Bit", "chip64Bit"
    };
    ...
    public void registerIcons(IIconRegister ir) {
        ...
        for (int x = 0; x < ITEMS.length; x++) {
            icons[x] = ir.registerIcon(InfinityItemsCore.MODID + ":component/" + ITEMS[x]);
        }
    }
