...
public class ItemCircular extends Item {

    public static final String[] ITEMS = new String[] {
            "basicircular","advancedcircular","rainforcedcircular","reseoncircular"
    };
    ...
    public ItemCircular() {
        ...
        this.setUnlocalizedName("circular");
    }
    ...
    public void registerIcons(IIconRegister ir) {
        ...
        for (int x = 0; x < ITEMS.length; x++) {
            icons[x] = ir.registerIcon(InfinityItemsCore.MODID + ":circular/" + ITEMS[x]);
        }
    }
