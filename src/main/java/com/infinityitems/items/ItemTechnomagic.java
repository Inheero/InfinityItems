...
public class ItemTechnomagic extends Item {

    public static final String[] ITEMS = new String[] {
            "thetree","draconicenergycore"
    };

    @SideOnly(Side.CLIENT)
    IIcon[] icons;

    public ItemTechnomagic() {
        this.setHasSubtypes(true);
        this.setUnlocalizedName("technomagic");
    }
    ...
    public void registerIcons(IIconRegister ir) {
        ...
        for (int x = 0; x < ITEMS.length; x++) {
            icons[x] = ir.registerIcon(InfinityItemsCore.MODID + ":" + ITEMS[x]);
        }
    }
