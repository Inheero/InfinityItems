...
public class DiamondFluid extends BlockFluidClassic {
    public DiamondFluid(Fluid fluid) {
        super(fluid, Material.lava);
        fluid.setBlock(this);
        setBlockName("fluid_diamond");
        setCreativeTab(InfinityItemsCore.tab);
        setBlockTextureName(InfinityItemsCore.MODID + ":diamond_still");
    }
...
//        }
    ...
    public void registerBlockIcons(IIconRegister register) {
        ...
        getFluid().setIcons(blockIcon, register.registerIcon(InfinityItemsCore.MODID + ":diamond_flow"));
    }
}
