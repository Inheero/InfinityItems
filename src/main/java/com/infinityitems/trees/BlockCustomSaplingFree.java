...
import com.infinityitems.worldgen.WorldGenCustomTreeFree;
...
public class BlockCustomSaplingFree extends BlockSapling {
    private IIcon[] icons;

    public  BlockCustomSaplingFree() {
        this.setBlockName("customSaplingFree");
        this.setBlockTextureName(InfinityItemsCore.MODID +":custom_sapling_free");
    ...
    public void generateTree(World world, int x, int y, int z, Random rand) {
        ...
        WorldGenCustomTreeFree treeGen = new WorldGenCustomTreeFree(InfinityItemsCore.customLogFree, InfinityItemsCore.customLeavesFree, true);
