...
import com.infinityitems.worldgen.WorldGenCustomTree;
...
public class BlockCustomSapling extends BlockSapling {
    ...
    public BlockCustomSapling() {
        this.setBlockName("customSapling");
        this.setBlockTextureName(InfinityItemsCore.MODID +":custom_sapling");
    ...
    public void generateTree(World world, int x, int y, int z, Random rand) {
        ...
        WorldGenCustomTree treeGen = new WorldGenCustomTree(InfinityItemsCore.customLog, InfinityItemsCore.customLeaves, true);
