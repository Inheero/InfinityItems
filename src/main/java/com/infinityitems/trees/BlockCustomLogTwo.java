...
public class BlockCustomLogTwo extends BlockLog {
    // Массив для хранения текстур
    private IIcon[] icons = new IIcon[3];

    public BlockCustomLogTwo() {
        super();
        this.setBlockName("custom_log_two"); // Название блока
        this.setBlockTextureName(InfinityItemsCore.MODID +":custom_log_two"); // Путь к текстуре
    }
