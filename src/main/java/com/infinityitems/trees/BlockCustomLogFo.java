...
public class BlockCustomLogFo extends BlockLog {
    // Массив для хранения текстур
    private IIcon[] icons = new IIcon[3];

    public BlockCustomLogFo() {
        super();
        this.setBlockName("custom_log_fo"); // Название блока
        this.setBlockTextureName(InfinityItemsCore.MODID +":custom_log_fo"); // Путь к текстуре
    }
