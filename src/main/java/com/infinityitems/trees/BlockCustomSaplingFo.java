...
import com.infinityitems.worldgen.WorldGenCustomTreeFo;
...
public class BlockCustomSaplingFo extends BlockSapling {
    private IIcon[] icons;

    public  BlockCustomSaplingFo() {
        this.setBlockName("customSaplingFo");
        this.setBlockTextureName(InfinityItemsCore.MODID +":custom_sapling_fo");
    ...
    public void generateTree(World world, int x, int y, int z, Random rand) {
        ...
        WorldGenCustomTreeFo treeGen = new WorldGenCustomTreeFo(InfinityItemsCore.customLogFo, InfinityItemsCore.customLeavesFo, true);
