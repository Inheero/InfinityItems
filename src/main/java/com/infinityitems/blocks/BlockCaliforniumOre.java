...
public class BlockCaliforniumOre extends Block {
    public BlockCaliforniumOre() {
        super(Material.rock);
        this.setBlockName("californiumOre");
        this.setBlockTextureName(MODID +":californium_ore");
